...
public class Station
{
    ...
    [MaxLength (255)]
    [Column(("address_en"))] public string AddressEn { get; set; }
    [MaxLength (255)]
    [Column(("lat"))] public string Lat { get; set; }
    [MaxLength (255)]
    [Column(("lng"))] public string Lng { get; set; }
    ...
    [MaxLength (255)]
    [Column(("invest_number"))] public string InvestNumber { get; set; }
